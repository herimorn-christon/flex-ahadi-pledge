...
->join('users','users.id','=','cards_members.user_id')
->get(['cards.card_no','cards.status','cards.created_at','users.fname','users.mname','users.lname']);
$i=1;
    ...
    <div class="my-5 " size="A4" style="margin-left:-9.4%;position:relative;top:-10%">
        <div class="p-5">
            ...
            <section class="store-user">
                    <center><h3 style="text-transform:capitalize;color:#22b8d1">our cards<h3></center>
                <table class="table"style="width:100%;" class="belly">
    
                    <tbody style="text-transform:capitalize" class="belly">
                      <tr class="belly">
                        <td class="belly">card number</td>
                        @foreach ( $cards as $card )
                        <td class="belly">{{$card->card_no}}</td>
                        @endforeach
                      </tr>
                    ...
                    <tbody class="belly1">
                     ...
                     ?>
                            ...
                            <tr class="belly1" style="text-transform:capitalize">
                               <td>{{ $i++}}</td>
                               <td>{{ $card->fname}} {{ $card->mname}}  {{ $card->lname}}</td>
                               <td>{{ $card->card_no}}</td>
                               <td>{{ $cardstatus }}</td>
