    ...
    <div class="my-5" size="A4" style="margin-left:-9.4%;position:relative;top:-10%">
        <div class="p-5">
            ...
            <section class="store-user">
                    <center><h3 style="text-transform:capitalize;color:#22b8d1">our purpouses<h3></center>
                <table class="table"style="width:100%;" class="belly">
    
                    <tbody style="text-transform:capitalize" class="belly">
                      <tr class="belly">
                        <td class="belly">total purpouse</td>
                        <td class="belly">{{$purpouses_count }}</td>
                      </tr>
                      <tr class="belly">
                        <td class="belly">uncomplished purpouse</td>
                        <td class="belly">{{$purpouses_count_uncomplished }}</td>
                      </tr>
                    </tbody>  
                  </table>
            </section>
                     ...
                     @endphp
                      ...
                      <?php
                        if($purpouse->status==0){
                         $purpouse->status='unfulfilled';
                          }else{
                              $purpouse->status='fulfilled'; 
                          }
                         ?>
          
                            <tr class="belly1" style="text-transform:capitalize">
                               <td>{{ $i++}}</td>
                               <td>{{ $purpouse->start_date }}</td>
                              <td>{{ $purpouse->title }}</td>
                              <td>{{ $purpouse->start_date }}</td>
                              <td>{{ $purpouse->end_date  }}</td>
                              <td>{{$purpouse->status  }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
