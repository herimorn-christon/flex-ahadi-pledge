      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-6">
          ...
          <div class="small-box bg-white">
            ...
            <br>
            <a href="" class=" mt-2 small-box-footer" type="button"  data-bs-toggle="modal" data-bs-target="#registeredModal">Generate Report <i class="fas fa-download text-primary"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-white">
              ...
              <br>
              <a href="" class="btn mt-2 small-box-footer" type="button"  data-bs-toggle="modal" data-bs-target="#registeredModal">Generate Report <i class="fas fa-download text-primary"></i></a>
            </div>
          </div>
