...
<div class="card mt-1">
    ...
    <div class="card-body">
        ...
        <div class="row">
                    ...
                    @endif
                <form action="{{ url('admin/edit-type/'.$type->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-lg-12 mb-3">
                        <div class="form-group">
                            <label for="title">Pledge Type Title</label>
                            <input name="title" type="text" value="{{ $type->title}}" class="form-control">
                        </div>
                    </div>
