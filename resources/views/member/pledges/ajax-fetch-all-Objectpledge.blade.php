...
<script type="text/javascript">
      showAllPledgesObject();
      ...
                          $("#pledges-table_object-body").html("");
                          let pledges = response.objectPledges;
                           console.log(pledges);
      ...
                                  ' onclick="showPledgeObject(' + pledges[i].id + ')"><i class="fa fa-eye"></i>' +
                              '</button> ';
      ...
                                  '<td>' + pledges[i].purpose.title + '</td>' +
                                   ...
                                   '<td>' + pledges[i].object_quantity + pledges[i].metrics+ '</td>' +   
      ...
                              '</tr>';
                              $("#pledges-table_object-body").append(pledgesRow);
                             
