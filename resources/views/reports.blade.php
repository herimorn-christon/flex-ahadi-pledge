    ...
    <nav class="navbar navbar-light bg-gradient-white static-top">
        <div class="container">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                @guest
                @if (Route::has('login'))
                <a href="{{ url('login') }}" class="btn  bg-flex text-light  mt-2 font-weight-light">Sign In To Your
                    Account</a>
                @endif
                @else
            ...
            <div class="row ">
                <div class="col-xl-6">
                    <div class=" text-white">
                        ...
                        <p class="mt-3" style="font-weight: bold;text-shadow: rgb(39 20 20 / 75%) 1px 0 10px;">Malachi
                            3:8, NIV</p>
                        ...
                        <form class="form-subscribe" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="row">
                                <div class="col-xl-8 mx-auto">
                                    <a data-bs-toggle="modal" data-bs-target="#registerModal" href="#myModal"
                                        class="btn bg-danger  mt-2">Join Us Now !</a>


                                    <a href="{{ url('login') }}" class="btn  bg-flex text-light mt-2 ">Sign In To Your
                                        Account</a>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                    name="phone" id="phone" placeholder="Phone Number/Nambari ya Simu"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="input-group mb-32">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror"
                                    name="password" id="password" placeholder="Password/Neno siri" aria-label="Password"
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="">
                                    <input id="mname" type="text" placeholder="Enter Middle Name"
                            ...
                            <div class="col-md-6 d-flex flex-column">
                                <label for="jumuiya" class="text-secondary">Jumuiya (Community)</label>
                                <select name="jumuiya" id="jumuiya" class="form-select">
                                    <option>secilia</option>
                                    <option>fransisco</option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group form-primary mb-3">
                                    <input id="password" type="date" class="form-control" name="date_of_birth"
                                        placeholder="">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row mx-1 ">
                                    ...
                                    <div class="col-md-4 form-check form-check-inline"><input type="radio" id="male"
                                            name="gender" value="male" class="form-check-input">
                                        <label class="form-check-label" for="male">Male</label>
                                    </div>
                                    <div class="col-md-4 form-check form-check-inline"><input type="radio" id="female"
                            ...
                            <div class="col-md-12 mb-0 ">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <button type="submit"
                                            class="btn btn-block text-decoration-none text-light bg-flex btn-block col-lg-12">
                                            {{ __('Register') }}
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                    <ul class="list-inline mb-2">
                        <li class="list-inline-item "><a href="#!" class="text-decoration-none text-light">About</a>
                        </li>
                        <li class="list-inline-item">⋅</li>
                        <li class="list-inline-item"><a href="#!" class="text-decoration-none text-light">Contact</a>
                        </li>
                        <li class="list-inline-item">⋅</li>
                        <li class="list-inline-item"><a href="#!" class="text-decoration-none text-light">Terms of
                                Use</a></li>
                        <li class="list-inline-item">⋅</li>
