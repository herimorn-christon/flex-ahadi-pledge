                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control " name="phone" id="phone" placeholder="Phone Number/Nambari ya Simu" aria-label="Username" aria-describedby="basic-addon1">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="input-group mb-32">
                            ...
                            <input type="password" class="form-control" name="password" id="password" placeholder="Password/Neno siri" aria-label="Password" aria-describedby="basic-addon1" required autocomplete="current-password">
