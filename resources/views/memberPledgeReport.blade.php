...
<body>
    @php
        ...
        $pledges_members=App\Models\Pledge::join('pledge_type','pledge_type.id','=','pledges.type_id')
                          ...
                          'pledges.created_at','pledges.deadline']);
                          //the culculation of the total pledges and the the other stuffs
                          $total=App\Models\Pledge::where("pledges.user_id",$user)->count();
    ...
    <div class="my-5 " size="A4" style="margin-left:-9.4%;position:relative;top:-10%">
        <div class="p-5">
            ...
            <section class="store-user">
                    <center><h3 style="text-transform:capitalize;color:#22b8d1">my pledges<h3></center>
                <table class="table"style="width:100%;" class="belly">
    
                    <tbody style="text-transform:capitalize" class="belly">
                      <tr class="belly">
                        <td class="belly">total pledge numbers</td>
