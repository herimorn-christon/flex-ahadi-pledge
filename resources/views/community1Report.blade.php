    ...
    <div class="my-5 " size="A4" style="margin-left:-9.4%;position:relative;top:-10%">
        <div class="p-5">
            <section class="top-content bb d-flex justify-content-between">
                ...
                <div class="top-left">
                    ...
                    <div class="position-relative">
                            ...
                            <p class="address"style="text-transform:capitalize">{{ $company->email }}, <br>P.O.Box {{ $company->postal_box  }}, <br>{{$company->city}}, </p>
            ...
            <section class="store-user">
                    <center><h3 style="text-transform:capitalize;color:#22b8d1">our communities<h3></center>
                <table class="table"style="width:100%;" class="belly">
    
                    <tbody style="text-transform:capitalize" class="belly">
                      <tr class="belly">
                        <td class="belly">jumla ya jumuiya</td>
                        <td class="belly">{{ $jumuiyas_count }}</td>
                      </tr>
                      <tr class="belly">
                        <td class="belly">jumla yawanachama</td>
                        <td class="belly">{{ $member_count }}</td>
                      </tr>
                    </tbody>  
                  </table>
            </section>
           <hr>
            ...
            <section class="product-area mt-4">
               <h3 class="thead" style="color:#ffffff;text-transform:capitalize;border-radius:5px;
                height:3rem;padding-top:11px">
                    communities report summary</h3>
                <table class="table table-hover table-bordered belly1">
                    <thead class="belly1">
                        <tr class>
                        <td>S/N</td>
                       <td>Jina La Jumuiya</td>
                        <td>Kifupisho</td>
                        <td>Mahali</td>
                        </tr>
                    </thead>
                    <tbody class="belly1">
                        ...
                        //$user=Auth::User()->id;
                            ...
                            <tr class="belly1" style="text-transform:capitalize">
                               <td>{{ $i++}}</td>
                               <td>{{ $jumuiya->name }}</td>
                               <td>{{ $jumuiya->abbreviation }}</td>
                              <td>{{ $jumuiya->location }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
